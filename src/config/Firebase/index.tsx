...
import { getFirestore, collection, addDoc, getDocs, doc, getDoc, updateDoc, deleteDoc, setDoc } from "firebase/firestore";
...
export { app, db, collection, addDoc, getFirestore, getDocs, getDoc, setDoc, doc, updateDoc, deleteDoc };